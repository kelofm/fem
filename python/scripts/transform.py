...
class InteractiveTransform:
    ...
    def __init__(self,
        ...
        # Static graphics
        self.__figure, (self.__localAxes, self.__transformedAxes) = pyplot.subplots(1, 2)
        ...
        self.__transformedAxes.set_xlim(2.5 * numpy.array([-self.__gridRadius, self.__gridRadius]))
        self.__transformedAxes.set_ylim(2.5 * numpy.array([-self.__gridRadius, self.__gridRadius]))
        self.__transformedAxes.set_title("Transformed Space")
        self.__transformedAxes.set_aspect("equal", "box")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t",
                        ...
                        type = str,
                        dest = "transformType",
                        choices = ["scale", "scale-translate", "affine", "projective"],
                        default = "projective")
